  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="hero-container relative min-h-[100vh] sm:min-h-screen">
          ...
          <div className="absolute inset-0 sm:hidden bg-gradient-to-br from-[#049704] via-[#038203] to-[#026502]">
            <picture>
              <source 
                media="(max-width: 480px)" 
                srcSet="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&q=80&w=480&h=800" 
              />
              <img 
                src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&q=80&w=768&h=1024" 
                alt="Professional waste management service"
          ...
          {/* Hero content */}
          <div className={`hero-content ${isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'} transition-all duration-1000 px-4 sm:px-6 lg:px-8`} style={{ paddingTop: '12vh' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <div className="text-center mb-6 sm:mb-8">
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 text-center">Proud Members Of</h2>
                <p className="mt-2 text-base sm:text-lg text-gray-700 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 items-center justify-items-center">
              <ScrollReveal delay={0.1}>
                <a 
                  ...
                  className="text-center group transition-transform duration-300 hover:-translate-y-1 p-4"
                >
                  <img 
                    src="/Images/AAGO.png" 
                    alt="Apartment Association of Greater Orlando Member" 
                    className="h-12 sm:h-16 lg:h-20 object-contain mx-auto mb-3 transition-transform duration-300 group-hover:scale-105"
                    loading="lazy"
                    decoding="async"
                    width="96"
                    height="96"
                  />
                  <p className="text-xs sm:text-sm text-gray-700 text-center leading-tight">Apartment Association of Greater Orlando</p>
                </a>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.2}>
                ...
                >
                  <img 
                    ...
                    height="96"
                  />
                  <p className="text-xs sm:text-sm text-gray-700 text-center leading-tight">Florida Apartment Association</p>
                </a>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                ...
                >
                  <img 
                    ...
                    height="96"
                  />
                  <p className="text-xs sm:text-sm text-gray-700 text-center leading-tight">National Apartment Association</p>
                </a>
              </ScrollReveal>
            </div>
          </div>
        ...
        {/* About Section */}
        <section className="py-12 sm:py-16 lg:py-24 bg-gray-100 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <ScrollReveal direction="left">
                <div className="text-center lg:text-left">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 text-center lg:text-left">Welcome to On The Fly Waste Solutions</h2>
                  ...
                  <div className="mt-6 sm:mt-8 text-center lg:text-left">
                    <Link to="/about" className="btn-primary w-full sm:w-auto" style={{ minHeight: '44px' }}>
              ...
              <ScrollReveal direction="right" delay={0.2}>
                <div className="w-full">
                  <div className="aspect-[4/3] relative rounded-xl overflow-hidden shadow-xl mt-8 lg:mt-0">
                    <picture>
                      <source 
                        media="(max-width: 480px)" 
                        srcSet="/Images/artemistradeshow.jpg" 
                      />
                    <img 
          ...
          <div className="max-w-7xl mx-auto">
            <ScrollReveal>
              <div className="text-center mb-8 sm:mb-12 lg:mb-16">
                <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-gray-900 mb-4 text-center">Waste Management Services</h2>
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-6 text-center">
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2 transition-colors duration-300 group-hover:text-[#049704] text-center">
                        {service.title}
                      </h3>
                      <p className="text-sm sm:text-base text-gray-700 mb-4 text-center leading-relaxed">{service.description}</p>
            ...
            <div className="text-center mt-8 sm:mt-12">
              <Link to="/contact" className="btn-primary w-full sm:w-auto" style={{ minHeight: '44px' }}>
          ...
          <div className="max-w-7xl mx-auto">
            <ScrollReveal>
              <div className="text-center mb-8 sm:mb-12">
                <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-gray-900 mb-4 text-center">Why Property Managers Choose Us</h2>
                <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {features.map((feature, index) => (
                <ScrollReveal 
                  ...
                  delay={index * 0.2}
                >
                  <div className="bg-gray-50 rounded-xl p-6 sm:p-8 shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl text-center h-full flex flex-col">
                    ...
                    <p className="text-sm sm:text-base text-gray-700 text-center leading-relaxed flex-1">{feature.description}</p>
                  </div>
                </ScrollReveal>
              ))}
            </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <ScrollReveal>
              <div className="text-center mb-8 sm:mb-12 lg:mb-16">
                <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-gray-900 mb-4 text-center">What Our Clients Say</h2>
                <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-8 sm:mb-12">
                ...
                <div className="space-y-6 sm:space-y-8">
                  {reviews.map((review, index) => (
                    <ScrollReveal 
                      ...
                      delay={index * 0.2}
                    >
                      <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                        <Quote className="h-8 w-8 text-[#049704]/20 mb-4" />
                        <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6 text-center leading-relaxed">{review.text}</p>
                        <div className="flex items-center justify-between">
                          <div className="text-center flex-1">
                            <h3 className="font-semibold text-gray-900 text-center text-sm sm:text-base">{review.name}</h3>
                            <p className="text-xs sm:text-sm text-gray-600 text-center">{review.location}</p>
                          </div>
                          <div className="flex">
              ...
              <ScrollReveal direction="right" delay={0.2}>
                <div className="sticky top-24 mt-8 lg:mt-0">
                  <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 shadow-lg">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 text-center">Watch Our Client Testimonials</h3>
                    ...
                    <p className="mt-4 text-sm sm:text-base text-gray-700 text-center">
            ...
            <div className="text-center">
              <Link to="/reviews" className="btn-primary w-full sm:w-auto" style={{ minHeight: '44px' }}>
        ...
        {/* Impact Section */}
        <section id="impact-section" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-[#026502] to-[#038203] relative overflow-hidden px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-base sm:text-lg text-white max-w-2xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                >
                  <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 hover:bg-white/20 transition-all duration-300 group">
                    ...
                    <div className="text-center">
                      <div className="text-2xl sm:text-3xl font-bold text-white mb-1 group-hover:scale-110 transition-transform duration-300 text-center">
                        {stat.number}
                      </div>
                      <div className="text-base sm:text-lg font-semibold text-white mb-1 text-center">
                        {stat.label}
                      </div>
            ...
            <div className="mt-6 sm:mt-8 text-center">
              <div className="inline-flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-6 bg-white/10 backdrop-blur-lg rounded-2xl sm:rounded-full px-4 sm:px-6 py-3">
                ...
                <div className="flex items-center text-white">
                  ...
                  <span className="text-sm sm:text-base">7 Days a Week</span>
                </div>
                <div className="hidden sm:block w-px h-6 bg-white/20"></div>
                <div className="flex items-center text-white">
                  <Truck className="h-5 w-5 mr-2" />
                  <span className="text-sm sm:text-base">Next Day Service</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gray-100 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 text-center">Contact Us</h2>
              <p className="mt-4 text-base sm:text-lg text-gray-700 text-center">
            ...
            <div className="mt-8 sm:mt-12 grid grid-cols-1 gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <a href="tel:407-274-5019" className="bg-white/80 backdrop-blur-lg p-6 sm:p-8 rounded-lg shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl text-center block" style={{ minHeight: '44px' }}>
                <Phone className="h-10 w-10 text-[#049704] mx-auto" />
                <h3 className="mt-4 text-lg sm:text-xl font-semibold text-gray-900 text-center">Phone</h3>
                <p className="mt-2 text-sm sm:text-base text-gray-700 text-center">407-274-5019</p>
              </a>

              <a href="mailto:info@ontheflywastesolutions.com" className="bg-white/80 backdrop-blur-lg p-6 sm:p-8 rounded-lg shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl text-center block" style={{ minHeight: '44px' }}>
                <Mail className="h-10 w-10 text-[#049704] mx-auto" />
                <h3 className="mt-4 text-lg sm:text-xl font-semibold text-gray-900 text-center">Email</h3>
                <p className="mt-2 text-xs sm:text-sm text-gray-700 text-center break-all">info@ontheflywastesolutions.com</p>
              </a>

              <div className="bg-white/80 backdrop-blur-lg p-6 sm:p-8 rounded-lg shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl text-center sm:col-span-2 lg:col-span-1">
                <MapPin className="h-10 w-10 text-[#049704] mx-auto" />
                <h3 className="mt-4 text-lg sm:text-xl font-semibold text-gray-900 text-center">Location</h3>
                <p className="mt-2 text-sm sm:text-base text-gray-700 text-center">Orlando, Florida</p>
              </div>
            </div>
          </div>
        </section>
