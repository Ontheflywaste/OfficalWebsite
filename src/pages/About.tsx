              ...
              <ScrollReveal direction="left">
                <div>
                  ...
                  <div className="prose prose-lg text-gray-600">
                    <p className="mb-4">
                      Since our founding in 2020, On The Fly Waste Solutions has been driven by a singular mission: to transform the <Link to="/services/valet-trash" className="text-[#049704] hover:text-[#038203] font-medium underline">valet trash</Link> and <Link to="/services/junk-removal" className="text-[#049704] hover:text-[#038203] font-medium underline">bulk removal</Link> industry through innovation, reliability, and exceptional service. Our journey began when we identified a critical gap in the market for high-quality, consistent valet trash services in Central Florida.
                    </p>
                    <p className="mb-4">
                      What sets us apart is our unwavering commitment to excellence and our innovative approach to valet trash and bulk removal. We've invested in cutting-edge technology and developed streamlined processes that ensure efficient, environmentally responsible service delivery. Our <Link to="/services/pressure-washing" className="text-[#049704] hover:text-[#038203] font-medium underline">pressure washing services</Link> complement our waste management offerings. Our team undergoes rigorous training to maintain the highest standards of professionalism and safety.
                    </p>
                    <p className="mb-4">
