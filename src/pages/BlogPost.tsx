          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <div className="mb-6">
                <Link 
                  to="/blog" 
                  className="inline-flex items-center text-[#049704] hover:text-[#038203] font-medium transition-colors duration-200"
                >
              ...
              <div className="aspect-video w-full rounded-xl overflow-hidden shadow-xl mb-8">
                <img
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollReveal>
              <h2 className="text-3xl font-bold text-white mb-6">
                Ready to Improve Your Property's Waste Management?
              </h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Get expert advice and professional service for your Orlando property
              </p>
