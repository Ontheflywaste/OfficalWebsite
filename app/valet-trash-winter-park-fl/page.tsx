...
export const metadata: Metadata = {
  ...
  description: 'Professional valet trash service for apartments, condos, and resorts in Winter Park, FL. 100% collection commitment with GPS-tracked truck routing and verified missed pickups made right. Premium service for luxury properties.',
  alternates: {
