      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-black">
          <img
            ...
            alt="Apartment community in Winter Garden FL"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
          <ScrollReveal>
            <div className="flex items-center justify-center gap-2 mb-4">
              <MapPin className="w-6 h-6 text-[#049704]" />
              <span className="text-white text-lg font-semibold">Serving Winter Garden, FL</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Valet Trash Service in Winter Garden, FL
            </h1>
            ...
            <ScrollReveal>
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-6">
                  Trusted Valet Trash Service for Winter Garden Apartment Communities
                </h2>
                <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                  On The Fly Waste Solutions provides comprehensive <strong>valet trash service</strong> to apartment communities throughout Winter Garden, FL. Our professional team ensures reliable doorstep trash collection with our industry-leading 100% collection guarantee.
                </p>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Serving Winter Garden's thriving community, we understand the unique needs of <strong>apartment waste management</strong> in this rapidly growing west Orlando area. Our comprehensive solutions help property managers maintain clean, attractive properties that residents love calling home.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-[#049704] flex-shrink-0 mt-1" />
                    <div>
            ...
            <ScrollReveal delay={0.2}>
              <div className="relative">
                <img
                  ...
                  alt="Valet trash service in Winter Garden FL apartment community"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Complete solutions for Winter Garden apartment communities
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ScrollReveal delay={0.1}>
              <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-100 hover:border-[#049704] transition-all">
                <div className="w-16 h-16 bg-[#049704] bg-opacity-10 rounded-lg flex items-center justify-center mb-6">
                  <Building2 className="w-10 h-10 text-[#049704]" />
                </div>
                ...
                <Link href="/services/valet-trash/" className="text-[#049704] font-semibold inline-flex items-center gap-2 hover:gap-4 transition-all">
            ...
            <ScrollReveal delay={0.2}>
              <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-100 hover:border-[#049704] transition-all">
                ...
                <Link href="/services/bulk-removal/" className="text-[#049704] font-semibold inline-flex items-center gap-2 hover:gap-4 transition-all">
                  Learn More <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3}>
              <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-100 hover:border-[#049704] transition-all">
                ...
                <Link href="/services/junk-removal/" className="text-[#049704] font-semibold inline-flex items-center gap-2 hover:gap-4 transition-all">
                  Learn More <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Why Winter Garden Properties Choose On The Fly
              </h2>
              <p className="text-xl text-gray-600">
                Trusted by property managers throughout Winter Garden and West Orlando
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border-t-8 border-[#049704]">
              <div className="text-center mb-8">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  Get Started with Valet Trash Service in Winter Garden
                </h2>
                <p className="text-xl text-gray-600">
                  Contact us today for a free quote tailored to your Winter Garden property
                </p>
              </div>
              <HubSpotForm
                region="na1"
