              ...
              <div className="w-full max-w-md">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-white/90 mb-6">
                    We don't operate like a distant national vendor. We stay connected, visible, and accountable. Our goal is to help property managers reduce complaints, boost curb appeal with our <Link to="/services/pressure-washing" className="text-[#049704] hover:text-[#038203] font-medium underline">pressure washing services</Link>, and feel confident that their community is in good hands.
                  </p>
                </div>
                <p className="mb-4 text-center lg:text-left">
                  Our core services include daily <Link to="/services/valet-trash" className="text-[#049704] hover:text-[#038203] font-medium underline">valet trash collection</Link> and on-demand <Link to="/services/junk-removal" className="text-[#049704] hover:text-[#038203] font-medium underline">bulk removal</Link>, handled by a hands-on team that shows up on time and gets the job done right. We pay attention to the small things—clean compactor areas, bag limits enforced, and quick communication when issues arise—because those details matter to your residents.
                </p>
