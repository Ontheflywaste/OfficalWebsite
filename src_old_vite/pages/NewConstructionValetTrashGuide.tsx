    ...
    <>
      ...
      <div className="min-h-screen pt-24">
        ...
        <section className="relative min-h-[70vh] bg-gradient-to-br from-gray-900 via-gray-800 to-[#049704] overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&q=80&w=1920')] bg-cover bg-center opacity-20" />
            ...
            <div className="flex flex-col justify-center items-center h-full text-center pt-40 pb-28">
              <ScrollReveal>
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                  Valet Trash for New
                  <span className="block text-[#049704]">Construction Apartments</span>
                </h1>
