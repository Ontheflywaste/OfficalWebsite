...
export const metadata: Metadata = {
  ...
  description: 'Door to door trash collection and doorstep trash pickup service for apartments, HOA, resort, and condo communities across Central Florida. GPS-verified, photo-stamped doorstep valet trash service. Orlando, Kissimmee, Champions Gate, Lake Nona.',
