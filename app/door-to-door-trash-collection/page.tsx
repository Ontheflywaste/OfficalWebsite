...
export const metadata: Metadata = {
  ...
  description: 'Door to door trash collection and doorstep trash pickup service for apartments, HOA, resort, and condo communities across Central Florida. GPS-tracked truck routing with a 100% collection commitment and same-night missed-pickup cure. Orlando, Kissimmee, Champions Gate, Lake Nona.',
