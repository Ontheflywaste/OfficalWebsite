    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-[100vh] bg-gradient-to-br from-[#049704] via-[#038203] to-[#026502] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/70 via-blue-500/50 to-blue-800/80" />
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">How Our Pressure Washing Works</h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Professional, efficient, and thorough cleaning process
                </p>
              </div>
            </ScrollReveal>
              ...
              {[
                {
                  ...
                  description: "We evaluate your property's surfaces and determine the appropriate cleaning methods and pressure settings for optimal results."
                },
                {
                  step: "2",
                  title: "Professional Cleaning",
                  description: "Using commercial-grade equipment and eco-friendly solutions, we thoroughly clean all surfaces with precision and care."
                },
                {
                  step: "3",
                  title: "Final Inspection",
                  description: "We conduct a thorough inspection to ensure all areas are properly cleaned and your property looks its absolute best."
                }
              ].map((step, index) => (
                <ScrollReveal 
                  key={index}
                ...
                >
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-semibent text-gray-900">{testimonial.name}</h4>
