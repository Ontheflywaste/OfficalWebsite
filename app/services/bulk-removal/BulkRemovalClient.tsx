    ...
    <div className="min-h-screen pt-32">
      <section className="relative py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <img src="/Images/Residential-Junk-Removal-McAllen-Dumpster-Rental-Junk-Removal-Services-1024x768-2.jpg" alt="Bulk Removal Service" className="w-full h-full object-cover" />
        </div>
          ...
          <ScrollReveal>
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-6">
                <Package className="w-12 h-12 text-[#027502]" />
                  ...
                  <ul className="space-y-3">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-[#027502] flex-shrink-0 mt-0.5" />
