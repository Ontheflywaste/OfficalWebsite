  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20">
      <div className="max-w-2xl w-full text-center">
        <div className="mb-8">
          <h1 className="text-9xl font-bold text-[#16a34a] mb-4">404</h1>
          ...
          <p className="text-sm text-gray-500 mb-8">
            Redirecting to our services page in <span className="font-bold text-[#16a34a]">{countdown}</span> seconds...
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Link
            href="/"
            className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 border-2 border-transparent hover:border-[#16a34a]"
          >
            <Home className="w-8 h-8 text-[#16a34a] mb-3" />
          ...
          <Link
            ...
            className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 border-2 border-transparent hover:border-[#16a34a]"
          >
            <Search className="w-8 h-8 text-[#16a34a] mb-3" />
          ...
          <Link
            ...
            className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 border-2 border-transparent hover:border-[#16a34a]"
          >
            <Phone className="w-8 h-8 text-[#16a34a] mb-3" />
        ...
        <div className="mt-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-[#16a34a] hover:text-[#15803d] font-semibold transition-colors"
          >
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-[#16a34a] to-[#027502] rounded-xl text-white">
