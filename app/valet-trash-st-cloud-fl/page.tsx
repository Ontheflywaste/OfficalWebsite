...
export const metadata: Metadata = {
  ...
  description: 'Professional valet trash service for apartments, condos, and resorts in St. Cloud, FL. 100% collection commitment with GPS-tracked truck routing and verified missed pickups made right. Serving Osceola County properties.',
  alternates: {
