    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="py-12 bg-white relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/Images/futuremillionaire.JPG')] opacity-15" style={{ backgroundPosition: 'center 60%', backgroundSize: '90%', backgroundRepeat: 'no-repeat' }} />
          <div className="absolute inset-0 bg-gradient-to-b from-green-50/80 to-white/70" />
