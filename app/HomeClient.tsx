          ...
          <div className="relative overflow-hidden">
            <div className="flex animate-scroll">
              <div className="flex items-center gap-20 flex-shrink-0">
                <div className="flex-shrink-0 h-24 min-w-[192px] w-48 flex items-center justify-center" style={{ filter: 'drop-shadow(0 4px 6px rgba(0, 0, 0, 0.3))' }}>
                  <img
                ...
                <a
                  ...
                  target="_blank"
                  rel="nofollow"
                  className="flex-shrink-0 h-24 min-w-[192px] w-48 flex items-center justify-center hover:scale-105 transition-transform"
              ...
              <div className="flex items-center gap-20 flex-shrink-0" aria-hidden="true">
                <div className="flex-shrink-0 h-24 min-w-[192px] w-48 flex items-center justify-center" style={{ filter: 'drop-shadow(0 4px 6px rgba(0, 0, 0, 0.3))' }}>
                  <img
                    src="/Images/faa-full-color-full-logo.png"
                    alt="Florida Apartment Association"
