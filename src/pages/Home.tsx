    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="py-12 bg-white relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/Images/Astonatuptown.jpg')] opacity-30" style={{ backgroundPosition: 'center 30%', backgroundSize: '150%', backgroundRepeat: 'no-repeat' }} />
