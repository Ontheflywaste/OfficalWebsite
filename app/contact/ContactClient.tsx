        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative animate-scale-in">
            ...
            <div className="text-center">
              ...
              <button
                onClick={() => setShowSuccess(false)}
                className="w-full bg-[#049704] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#038503] transition-all"
              >
                Close
              </button>
            </div>
                ...
                <div className="bg-gradient-to-br from-[#049704] to-[#027502] rounded-2xl p-8 text-white shadow-xl">
                  ...
                  <div className="mt-8 p-6 bg-white/10 rounded-xl backdrop-blur-sm">
                    ...
                    <a
                      ...
                      className="block w-full text-center bg-white text-[#049704] px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition-all"
                    >
                      (407) 274-5019
                    </a>
                  </div>
