      ...
      <div className="max-w-2xl w-full text-center">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 mb-8">
            Redirecting to our services page in <span className="font-bold text-primary">{countdown}</span> seconds...
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Link
            href="/"
            className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 border-2 border-transparent hover:border-primary"
          >
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-primary to-[#027502] rounded-xl text-white">
