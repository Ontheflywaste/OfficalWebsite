    ...
    <>
      ...
      <div className="min-h-screen pt-24 md:pt-0">
        ...
        <div className="relative min-h-[100vh] bg-gradient-to-br from-blue-900 via-blue-800 to-[#049704] overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full pt-24">
            <div className="flex flex-col justify-center items-center h-full text-center pt-8">
              <ScrollReveal>
                <div className="mb-6">
