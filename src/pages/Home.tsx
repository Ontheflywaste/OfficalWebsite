    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="py-12 bg-white relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/Images/futuremillionaire.JPG')] opacity-15" style={{ backgroundPosition: 'center 15%', backgroundSize: '90%', backgroundRepeat: 'no-repeat' }} />
